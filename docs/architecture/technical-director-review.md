...
> **历史决策提示（2026-09-01）：** 地域和编辑流水线已更新：资讯第一阶段为全澳洲、全部移民类型，低风险内容经证据绑定和独立复核后可自动发布；高风险/冲突转人工。以 [../product/scope-decision-2026-09-01.md](../product/scope-decision-2026-09-01.md) 为准。
